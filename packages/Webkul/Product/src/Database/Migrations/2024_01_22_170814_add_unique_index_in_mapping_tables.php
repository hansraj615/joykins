...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('product_bundle_option_translations', function (Blueprint $table) {
            $table->string('locale', 50)->change(); // <-- Also reduce locale if needed
            $table->string('label', 150)->nullable()->change(); // Only this line is needed

            $table->unique(
                ['locale', 'label', 'product_bundle_option_id'],
                'bundle_option_translations_locale_label_bundle_option_id_unique'
            );
        });
